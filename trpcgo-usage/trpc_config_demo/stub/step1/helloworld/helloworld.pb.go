...
const file_pb_helloworld_proto_rawDesc = "" +
	...
	"\x05Hello\x12\x18.helloworld.HelloRequest\x1a\x19.helloworld.HelloResponseB\x12Z\x10step1/helloworldb\x06proto3"
...
var file_pb_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.HelloWorldService.Hello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.HelloWorldService.Hello:output_type -> helloworld.HelloResponse

...
const file_pb_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x13pb/helloworld.proto\x12\x0etprc.user.demo\" \n" +
	"\fHelloRequest\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg\"!\n" +
	"\rHelloResponse\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg2Y\n" +
	"\x11HelloWorldService\x12D\n" +
	"\x05Hello\x12\x1c.tprc.user.demo.HelloRequest\x1a\x1d.tprc.user.demo.HelloResponseB\x11Z\x0fuser/helloworldb\x06proto3"
...
var file_pb_helloworld_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: tprc.user.demo.HelloRequest
	(*HelloResponse)(nil), // 1: tprc.user.demo.HelloResponse
}
var file_pb_helloworld_proto_depIdxs = []int32{
	0, // 0: tprc.user.demo.HelloWorldService.Hello:input_type -> tprc.user.demo.HelloRequest
	1, // 1: tprc.user.demo.HelloWorldService.Hello:output_type -> tprc.user.demo.HelloResponse

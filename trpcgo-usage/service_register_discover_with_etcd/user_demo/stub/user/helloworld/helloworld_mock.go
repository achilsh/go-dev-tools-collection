...
// Source: stub/user/helloworld/helloworld.trpc.go
//
// Generated by this command:
//
//	mockgen -destination=stub/user/helloworld/helloworld_mock.go -package=helloworld -self_package=user/helloworld --source=stub/user/helloworld/helloworld.trpc.go
//

...
//go:generate mockgen -destination=stub/student/helloworld/helloworld_mock.go -package=helloworld -self_package=student/helloworld --source=stub/student/helloworld/helloworld.trpc.go

...
type HelloWorldServiceService interface {
	...
	Hello(ctx context.Context, req *HelloRequest) (*HelloResponse, error) // @alias=/student/hello
}
...
var HelloWorldServiceServer_ServiceDesc = server.ServiceDesc{
	ServiceName: "trpc.student.demo.HelloWorldService",
	...
	Methods: []server.Method{
		...
		{
			Name: "/trpc.student.demo.HelloWorldService/Hello",
			Func: HelloWorldServiceService_Hello_Handler,
		},
	},
}
...
type HelloWorldServiceClientProxy interface {
	// Hello Hello says hello.
	Hello(ctx context.Context, req *HelloRequest, opts ...client.Option) (rsp *HelloResponse, err error) // @alias=/student/hello
}

...
const file_pb_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x13pb/helloworld.proto\x12\x12trpc.first.student\" \n" +
	"\fHelloRequest\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg\"!\n" +
	"\rHelloResponse\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg2^\n" +
	"\x0eStudentService\x12L\n" +
	"\x05Hello\x12 .trpc.first.student.HelloRequest\x1a!.trpc.first.student.HelloResponseB!Z\x1fhello_world_demo/my_hello_worldb\x06proto3"
...
var file_pb_helloworld_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: trpc.first.student.HelloRequest
	(*HelloResponse)(nil), // 1: trpc.first.student.HelloResponse
}
var file_pb_helloworld_proto_depIdxs = []int32{
	0, // 0: trpc.first.student.StudentService.Hello:input_type -> trpc.first.student.HelloRequest
	1, // 1: trpc.first.student.StudentService.Hello:output_type -> trpc.first.student.HelloResponse

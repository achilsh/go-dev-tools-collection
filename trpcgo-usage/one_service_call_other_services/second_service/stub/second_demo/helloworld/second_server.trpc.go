...
var GreeterServer_ServiceDesc = server.ServiceDesc{
	ServiceName: "trpc.second.helloworld.Greeter",
	HandlerType: ((*GreeterService)(nil)),
	Methods: []server.Method{
		{
			Name: "/trpc.second.helloworld.Greeter/SayHello",
...
func HelloService_SayHi_Handler(svr interface{}, ctx context.Context, f server.FilterFunc) (interface{}, error) {
	req := &HelloRequest{}
	filters, err := f(req)
	if err != nil {
		return nil, err
	...
	handleFunc := func(ctx context.Context, reqbody interface{}) (interface{}, error) {
		return svr.(HelloService).SayHi(ctx, reqbody.(*HelloRequest))
	}
...
var HelloServer_ServiceDesc = server.ServiceDesc{
	ServiceName: "trpc.second.helloworld.Hello",
	HandlerType: ((*HelloService)(nil)),
	Methods: []server.Method{
		{
			Name: "/trpc.second.helloworld.Hello/SayHi",
			Func: HelloService_SayHi_Handler,
		},
	},
}
...
func (s *UnimplementedHello) SayHi(ctx context.Context, req *HelloRequest) (*HelloReply, error) {
	return nil, errors.New("rpc SayHi of service Hello is not implemented")
}
...
func (c *GreeterClientProxyImpl) SayHello(ctx context.Context, req *HelloRequest, opts ...client.Option) (*HelloReply, error) {
	...
	msg.WithClientRPCName("/trpc.second.helloworld.Greeter/SayHello")
	msg.WithCalleeServiceName(GreeterServer_ServiceDesc.ServiceName)
	msg.WithCalleeApp("second")
...
func (c *HelloClientProxyImpl) SayHi(ctx context.Context, req *HelloRequest, opts ...client.Option) (*HelloReply, error) {
	ctx, msg := codec.WithCloneMessage(ctx)
	defer codec.PutBackMessage(msg)
	msg.WithClientRPCName("/trpc.second.helloworld.Hello/SayHi")

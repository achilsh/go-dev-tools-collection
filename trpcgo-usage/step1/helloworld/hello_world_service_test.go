...
//go:generate mockgen -destination=stub/step1/helloworld/helloworld_mock.go -package=helloworld -self_package=step1/helloworld --source=stub/step1/helloworld/helloworld.trpc.go
